...
from file_reader import load_annotation, load_label_list, load_result
path = os.getcwd() + '/'
...
if __name__ == "__main__":
    with open(path + "../../config/utils/evaluation/evaluation_all_full_esm2_geneexpression_biolinkbert_tfidfd2v.json") as fp:
        config = json.load(fp)
