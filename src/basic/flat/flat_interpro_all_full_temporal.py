...
if __name__ == "__main__":
    conf_path = "../../../config/basic/flat/flat_InterPro_temporal_22.json"
    ...
    with open(config["result"]["ltr"], "w") as fp:
        json.dump(combined_ltr_result, fp)#, orient='index')# indent=2, orient='index')
    with open(config["result"]["test"], "w") as fp:
        json.dump(combined_test_result, fp)#, orient='index')# indent=2, orient='index')
